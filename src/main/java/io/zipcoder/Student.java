...
public class Student {
    ...
    public Student(String firstName, String lastName, Object o) {
        this(30);
    }

    public Student(int maxNumberOfStudents) {
        this.maxNumberOfStudents = maxNumberOfStudents;
        studentList = new ArrayList<Student>(Arrays.asList(new Student[maxNumberOfStudents]));
    }

    public Student(Student[] studentArray) {
    ...
    public void setGrade(int i, int size) {
    }
