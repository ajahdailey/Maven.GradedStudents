...
public class ClassroomTest {
    ...
    public void setup() {
        ...
        studentArray[0] = new Student("Ajah", "Dailey", new Double[]{12.0, 33.0, 55.0});
        studentArray[1] = new Student("Ashley", "Smith", new Double[]{19.0, 20.0, 45.0});
        studentArray[2] = new Student("Kyle", "Jackson", new Double[]{32.0, 30.0, 45.0});
        studentArray[3] = new Student("Brian", "Smith", new Double[]{33.0, 30.0, 39.0});
        studentArray[4] = new Student("Kevin", "Smith", new Double[]{25.0, 40.0, 55.0});
    }
    ...
    public void addStudentTest() {
        Classroom classroom = new Classroom();
        Student student = new Student("Ajah", "Dailey",
